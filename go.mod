...
replace (
	github.com/openshift-online/rosa-hyperfleet-api/api => ../rosa-hyperfleet-api/api
	github.com/openshift-online/rosa-hyperfleet-api/clientset => ../rosa-hyperfleet-api/clientset
)
